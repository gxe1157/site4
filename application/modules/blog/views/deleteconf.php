...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<h2>Blog Entry Title: <?= $page_title ?></h2>				
		
			<p>Are you sure that you want to delete the item?</p>

			<?php echo form_open_multipart('blog/delete/'.$update_id, array('class' => 'form-horizontal') ); ?>
			  	<fieldset>
					<div class="control-group">
							<button type="submit" class="btn btn-danger" name="submit" value="Yes - Delete Blog Entry">Yes - Delete Blog Entry</button>
