...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Admin for ......</span></a>
	...
	<div class="row-fluid">
		<!-- start: Main Menu -->
		<div id="sidebar-left" class="span2"  style="border: 0px solid red; ">
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2013-<?php echo date("Y"); ?> &nbsp;<a href="http://themifycloud.com/downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">Admin... Responsive Dashboard</a></span>
